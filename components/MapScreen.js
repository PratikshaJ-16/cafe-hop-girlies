...
if (errorMsg) {
  ...
  image={customMarker}
  onPress={() => {
    console.log("Cafe pressed:", cafe.name);
...
<TouchableOpacity
  style={styles.groupPlannerButton}
  activeOpacity={0.85}
  onPress={() => navigation.navigate('GroupPlanner')}
>
  <Text style={styles.groupPlannerButtonText}>
    👥 Plan With Friends
  </Text>
</TouchableOpacity>
